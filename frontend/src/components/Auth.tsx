...
import { SignupInput } from "@mairaz457/medium-common"
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-4">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Mohammad Mairaz ..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    ...
                    <button onClick={sendRequest} type="button" className="mt-8 w-full text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg 
